...
import { ChevronRight, ChevronDown, Check, RotateCcw, BookOpen, Info, ScrollText, Plus, X, Trash2, Settings, BarChart3, LogOut, Sparkles, HandHeart, Users, CheckSquare } from 'lucide-react-native';
...
function SahabaCard({ sahaba, onDelete }: { sahaba: Sahaba; onEdit: (s: Sahaba) => void; onDelete?: (id: string) => void }) {
...
function ProphetCard({ prophet, onDelete }: { prophet: Prophet; onEdit: (p: Prophet) => void; onDelete?: (id: string) => void }) {
  const [expanded, setExpanded] = useState<boolean>(false);
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <>
            <View style={styles.prophetIntro}>
              ...
              <Text style={styles.prophetIntroText}>
                Appuyez pour lire les histoires des prophètes
              </Text>
            </View>
        ...
        {activeSection === 'sahabas' && (
          <>
            <View style={styles.prophetIntro}>
              <BookOpen size={20} color={Colors.primary} />
              <Text style={styles.prophetIntroText}>
                Appuyez pour lire les histoires des compagnons et savants
              </Text>
            </View>
        ...
        {activeSection === 'settings' && (
          <>
            ...
            <Text style={styles.sectionLabel}>Contenu spirituel</Text>
            <View style={styles.settingsGroup}>
              <Pressable onPress={() => router.push('/(tabs)/more/dhikr' as any)} style={styles.settingRow}>
                <View style={styles.settingIcon}>
                  <Sparkles size={20} color={Colors.primary} />
                </View>
                <Text style={styles.settingLabel}>Dhikr</Text>
                <ChevronRight size={18} color={Colors.textMuted} />
              </Pressable>
              <Pressable onPress={() => router.push('/(tabs)/more/duas' as any)} style={styles.settingRow}>
                <View style={styles.settingIcon}>
                  <HandHeart size={20} color={Colors.primary} />
                </View>
                <Text style={styles.settingLabel}>Duas</Text>
                <ChevronRight size={18} color={Colors.textMuted} />
              </Pressable>
              <Pressable onPress={() => router.push('/(tabs)/more/prophets' as any)} style={styles.settingRow}>
                <View style={styles.settingIcon}>
                  <BookOpen size={20} color={Colors.primary} />
                </View>
                <Text style={styles.settingLabel}>Prophètes</Text>
                <ChevronRight size={18} color={Colors.textMuted} />
              </Pressable>
              <Pressable onPress={() => router.push('/(tabs)/more/sahabas' as any)} style={styles.settingRow}>
                <View style={styles.settingIcon}>
                  <Users size={20} color={Colors.primary} />
                </View>
                <Text style={styles.settingLabel}>Sahabas & Savants</Text>
                <ChevronRight size={18} color={Colors.textMuted} />
              </Pressable>
              <Pressable onPress={() => router.push('/(tabs)/more/habits' as any)} style={styles.settingRow}>
                <View style={styles.settingIcon}>
                  <CheckSquare size={20} color={Colors.primary} />
                </View>
                <Text style={styles.settingLabel}>Habitudes</Text>
                <ChevronRight size={18} color={Colors.textMuted} />
              </Pressable>
            </View>
