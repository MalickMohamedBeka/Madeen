...
import { RotateCcw, Check, ChevronDown, Heart, Plus, X, Search, Trash2, BookOpen, Minus, Compass } from 'lucide-react-native';
...
function QuranTab() {
  const { quranProgress, incrementQuranPages, decrementQuranPages, updateQuranProgress } = useRamadan();
  const scaleAnim = useRef(new Animated.Value(1)).current;
      ...
      <View style={styles.quranMainCard}>
        ...
        <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
          <View style={styles.quranCounterRow}>
            ...
            <View style={styles.quranTotalBadge}>
              <Text style={styles.quranTotalText}>{quranProgress.totalPagesRead}</Text>
              <Text style={styles.quranTotalLabel}>total</Text>
            </View>
          </View>
        </Animated.View>
      </View>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        <View style={styles.headerTop}>
          ...
          <View style={styles.headerActions}>
            <Pressable onPress={() => router.push('/(tabs)/worship/qibla' as never)} style={styles.qiblaBtn} testID="qibla-btn">
