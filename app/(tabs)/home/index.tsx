...
export default function HomeScreen() {
  ...
  const {
    ...
    streak, userLocation, weather, quranProgress, prayerTimes, refreshLocation, refreshWeather, syncTranslations,
  } = useRamadan();
  ...
  const onRefresh = React.useCallback(async () => {
    ...
    setNow(new Date());
    // Refresh location, weather, and sync translations
    await Promise.all([
      refreshLocation(),
      refreshWeather(),
      syncTranslations(),
  ...
  const gregorian = useMemo(() => getGregorianFormatted(now), [now]);
