...
export const slideUp = (animatedValue: Animated.Value, _duration = 400) => {
...
export const slideDown = (animatedValue: Animated.Value, toValue: number, _duration = 400) => {
  return Animated.spring(animatedValue, {
    toValue,
    useNativeDriver: true,
    friction: 8,
...
export const scaleIn = (animatedValue: Animated.Value, _duration = 300) => {
  return Animated.spring(animatedValue, {
    toValue: 1,
    useNativeDriver: true,
    friction: 6,
...
export const scaleOut = (animatedValue: Animated.Value, _duration = 300) => {
  return Animated.spring(animatedValue, {
    toValue: 0,
    useNativeDriver: true,
    friction: 6,
